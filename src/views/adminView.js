export default function adminView() {
    ...
    <div class="p-5">
        ...
        <div class="flex flex-wrap gap-3 mt-4">
            <select id="filtroStatus" class="bg-gray-200 rounded-lg p-2">
                <option value="">Todos los estados</option>
                <option value="pendiente">Pendiente</option>
                <option value="process">En proceso</option>
                <option value="completed">Completada</option>
            </select>
            <input type="text" id="filtroSearch" placeholder="Buscar tarea..." class="bg-gray-200 rounded-lg p-2">
            <input type="text" id="filtroUser" placeholder="ID de usuario..." class="bg-gray-200 rounded-lg p-2 w-36">
