export default function userView(){
    ...
    <div class= "p-5">
        ...
        <form id="todoForm" class="flex flex-col gap-3 mt-4">
            <input type="text" id="titulo" placeholder="Título de la tarea" class="bg-gray-200 rounded-lg p-2">
            <textarea id="descripcion" placeholder="Descripción" class="bg-gray-200 rounded-lg p-2 resize-none"></textarea>
